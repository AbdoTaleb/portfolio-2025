      ...
      <div className="right-side fade-in">
        <ul className="project-list">
          <li className="project-item">
            ...
            <span>
              The Wild Oasis: full-stack app with authentication, API routes, and dynamic data handling using Next.js. Includes booking logic and backend
              functionality.
            </span>{" "}
            <br />
            <span>
              <strong>Technologies:</strong> Next.js, Tailwind CSS, API Routes, Supabase
            </span>
            <a
              href="https://the-wild-oasis-git-main-abdotalebs-projects.vercel.app/"
              target="_blank"
              rel="noreferrer"
          ...
          <li className="project-item">
            ...
            <span>
              Sneaker store: product listing with images, pagination, and product details. Backend hosted on Render (.NET 8 Web API) with Azure SQL for data.
            </span>{" "}
            <br />
            <span>
              <strong>Technologies:</strong> React, SCSS, Axios, ASP.NET Core Web API, SQL Server (Azure)
            </span>
            <a
          ...
          <li className="project-item">
            ...
            <span>
              <strong>Technologies:</strong> React, SCSS, JavaScript
            </span>
            <a
          ...
          <li className="project-item">
            ...
            <span>
              <strong>Technologies:</strong> React, Redux Toolkit, Styled Components
            </span>
            <a
