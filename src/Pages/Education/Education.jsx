...
function Education() {
  ...
  return (
    <section className={`education-page ${animate ? "animate" : ""}`}>
      ...
      <div className="education-intro fade-in">
        <p className="label">Education</p>

        <p>My academic background in software engineering and modern development.</p>

        <p>These programs helped me build strong foundations in backend development, system architecture, and full-stack technologies.</p>
      </div>

      <div className="education-main fade-in">
